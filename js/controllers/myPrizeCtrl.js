mainModule.controller('myPrizeCtrl', ['$scope','$filter','$location','$localStorage','resourceService','$state','storage',function($scope,$filter,$location,$localStorage,resourceService,$state,storage) {
	// $scope.action=1;
	$scope.page={};
	$scope.page.pageOn=1;
	...
	var init=function(){
		...
		resourceService.queryPost($scope,$filter('交互接口对照表')('getJeCadeaux'),obj,'我的奖品');
	}
